...
$sql = 'SELECT * FROM repositorio_ige';
...
<body>
  <?php
  if (!$_GET) {
    header('Location:R_IGE.php?pagina=1');
  }
  ...
  $sql_ctrl = 'SELECT * FROM repositorio_ige LIMIT :iniciar,:nprog';
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <li><a class="dropdown-item" href="#">Ingenieria en gestion empresarial</a></li>
  ...
  <nav aria-label="Page navigation example">
    <ul class="pagination justify-content-center">
      <li class="page-item <?php echo $_GET['pagina'] <= 1 ? 'disabled' : '' ?> ">
        <a class="page-link" href="R_IGE.php?pagina=<?php echo $_GET['pagina'] - 1 ?>">Anterior</a>
      </li>
      <?php for ($i = 0; $i < $paginas; $i++) : ?>
        <li class="page-item <?php echo $_GET['pagina'] == $i + 1 ? 'active' : '' ?>"><a class="page-link" href="R_IGE.php?pagina=<?php echo $i + 1 ?>"><?php echo $i + 1 ?></a></li>
      <?php endfor; ?>
      <li class="page-item <?php echo $_GET['pagina'] >= $paginas ? 'disabled' : '' ?>">
        <a class="page-link" href="R_IGE.php?pagina=<?php echo $_GET['pagina'] + 1 ?>">Suiguiente</a>
      </li>
    </ul>
  </nav>
